...
use App\Http\Controllers\ShuttleArrivalController;
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/booking/{shuttleScheduleId}/confirmation', [BookingConfirmationController::class, 'create'])
        ->name('booking.confirmation');
    Route::post('/booking/{shuttleScheduleId}/confirmation', [BookingConfirmationController::class, 'store'])
        ->name('booking.confirmation.result');
    ...
    Route::post('/shuttles/{shuttleScheduleId}/arrive', [ShuttleArrivalController::class, 'store'])
        ->name('shuttles.arrive');
});
